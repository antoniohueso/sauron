angular.module('sauronApp').directive('reanudar'
    , function (RESTService, $filter, $rootScope,$q) {
        ...
        function link(scope,element,attrs) {
             ...
             ******************************************************************/
            scope.onOk = function() {
                RESTService.solicitud.reanudar(scope.form).then(function (o) {
                    scope.close();
                    updateRow(scope,o);
                    $rootScope.alertOk('Solicitud reanudada',['Solicitud ID: ' + o.id]);
                });
            };
        ...
        return {
            ...
            link:link,
            templateUrl: 'app/solicitud1/reanudar-form.html'
        };
